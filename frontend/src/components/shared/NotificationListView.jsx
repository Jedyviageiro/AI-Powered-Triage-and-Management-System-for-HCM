      ...
      >
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          <button
            ...
            style={{ width: "auto", padding: "9px 14px", fontSize: "13px", borderRadius: "999px" }}
          >
        ...
        {loading && notifications.length === 0 ? (
          <div style={{ padding: "16px", display: "grid", gap: "10px" }}>
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                ...
                style={{ height: "16px", width: i % 2 === 0 ? "100%" : "90%" }}
              />
            ))}
          </div>
          ...
          <div style={{ display: "grid" }}>
            {notifications.map((n) => {
              ...
              const safeTitle = toSafeNotificationText(n?.title, "Notificação");
              const safeMessage = toSafeNotificationText(n?.message, "-");
